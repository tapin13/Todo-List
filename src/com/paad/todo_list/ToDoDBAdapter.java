...
public class ToDoDBAdapter {
	...
	public boolean removeTask(long _rowIndex) {
		//Log.w("TaskDBAdapter", "removeTask _rowIndex: " + _rowIndex);
	...
	public Cursor setCursorToDoItem(long _rowIndex) throws SQLException {
		Cursor result = db.query(true, DATABASE_TABLE
				, new String[] {KEY_ID, KEY_TASK}, KEY_ID + "=" + _rowIndex, null, null, null, null, null);
	...
	private static class toDoDBOpenHelper extends SQLiteOpenHelper {
		...
		public void onUpgrade(SQLiteDatabase _db, int _oldVersion, int _newVersion) {
			Log.w("TaskDBAdapter", "Upgraiding from version " + 
